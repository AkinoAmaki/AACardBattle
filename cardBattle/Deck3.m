...
- (id)init{
    self = [super init];
    if(self){
        self.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"デッキ3" image:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"chisel_tip_marker-26" ofType:@"png"]] tag:3];
    }
    return  self;
}
