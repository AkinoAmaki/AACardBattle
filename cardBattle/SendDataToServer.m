...
-(NSString *)send{
    ...
    NSArray *myBattleData_parameter = [[NSArray alloc] initWithObjects:
                                       ...
                                       //----------------
                                       [NSNumber numberWithInt:app.enemyGikoFundamentalAttackPower],
                                       [NSNumber numberWithInt:app.enemyGikoFundamentalDeffencePower],
                                       [NSNumber numberWithInt:app.enemyMonarFundamentalAttackPower],
                                       [NSNumber numberWithInt:app.enemyMonarFundamentalDeffencePower],
                                       [NSNumber numberWithInt:app.enemySyobonFundamentalAttackPower],
                                       [NSNumber numberWithInt:app.enemySyobonFundamentalDeffencePower],
                                       [NSNumber numberWithInt:app.enemyYaruoFundamentalAttackPower],
                                       [NSNumber numberWithInt:app.enemyYaruoFundamentalDeffencePower],
                                       [NSNumber numberWithInt:app.enemyGikoModifyingAttackPower],
                                       [NSNumber numberWithInt:app.enemyGikoModifyingDeffencePower],
                                       [NSNumber numberWithInt:app.enemyMonarModifyingAttackPower],
                                       [NSNumber numberWithInt:app.enemyMonarModifyingDeffencePower],
                                       [NSNumber numberWithInt:app.enemySyobonModifyingAttackPower],
                                       [NSNumber numberWithInt:app.enemySyobonModifyingDeffencePower],
                                       [NSNumber numberWithInt:app.enemyYaruoModifyingAttackPower],
                                       [NSNumber numberWithInt:app.enemyYaruoModifyingDeffencePower],
                                       ...
                                       [NSNumber numberWithBool:app.canEnemyPlaySorceryCard],
                                       [NSNumber numberWithBool:app.canEnemyPlayFieldCard],
                                       [NSNumber numberWithBool:app.canEnemyActivateFieldCard],
                                       [NSNumber numberWithBool:app.canEnemyPlayEnergyCard],
                                       [NSNumber numberWithBool:app.canEnemyActivateEnergyCard],
