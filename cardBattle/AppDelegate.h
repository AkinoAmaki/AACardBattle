...
@property (nonatomic, retain) UIImageView *arrow; //タップする場所を指示する矢印(右向き)
@property (nonatomic, retain) UIImageView *arrowR; //タップする場所を指示する矢印(左向き)

//双方に関係する変数及び基礎的な変数
@property UIFont *tanukiFont;
...
@property BOOL doEnemyActivate; //対戦相手の検索時に自分が相手を見つけたが、相手が自分を見つけていない場合にNOになる。それ以外はYES。
...
@property int myDamageInBattlePhase; //バトルフェイズに表示される、自分に与えられるダメージ
...
@property int enemyDamageInBattlePhase; //バトルフェイズに表示される、相手に与えられるダメージ
