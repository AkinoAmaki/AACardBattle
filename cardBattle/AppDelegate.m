...
//                                                                              nil];
        ...
        NSArray *firstDeck1 = [[NSArray alloc] initWithObjects:[NSNumber numberWithInt:0],
                                     [NSNumber numberWithInt:0],
                                     [NSNumber numberWithInt:0],
                                     [NSNumber numberWithInt:0],
        ...
        NSArray *firstDeck2 = [[NSArray alloc] initWithObjects:[NSNumber numberWithInt:0],
                                     [NSNumber numberWithInt:0],
                                     [NSNumber numberWithInt:0],
        ...
        NSArray *firstDeck3 = [[NSArray alloc] initWithObjects:[NSNumber numberWithInt:0],
        ...
        [ud setObject:firstDeck1 forKey:@"myDeck_ud1"];
        [ud setObject:firstDeck2 forKey:@"myDeck_ud2"];
        [ud setObject:firstDeck3 forKey:@"myDeck_ud3"];
        
        //各種デッキ名を初期化
        [ud setObject:@"赤の崩壊デッキ" forKey:@"deckName1"];
        [ud setObject:@"黒緑の猛撃デッキ" forKey:@"deckName2"];
        [ud setObject:@"白青の大盾デッキ" forKey:@"deckName3"];
    ...
    //BGMの実装
    //決定ボタンタップ音
    if([[NSFileManager defaultManager] fileExistsAtPath:[[NSBundle mainBundle] pathForResource:@"buttonPushed" ofType:@"wav"]]){
        NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"buttonPushed" ofType:@"wav"]];
        AudioServicesCreateSystemSoundID((CFURLRef)CFBridgingRetain(url), &tapSoundID);
    }
    
    //キャンセルボタンタップ音
    if([[NSFileManager defaultManager] fileExistsAtPath:[[NSBundle mainBundle] pathForResource:@"se_maoudamashii_system10" ofType:@"mp3"]]){
        NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"se_maoudamashii_system10" ofType:@"mp3"]];
        AudioServicesCreateSystemSoundID((CFURLRef)CFBridgingRetain(url), &cancelSoundID);
    }
...
#pragma mark- カード関連のデータ（カード名、カードナンバー等）の配列
 ...
 nil];
    _cardList_cost = [[NSArray alloc] initWithObjects: @"null", @"0",	@"0",	@"0",	@"0",	@"0",	@"W",	@"W2",	@"W",	@"W2",	@"W2",	@"W1",	@"W1",	@"W1",	@"W1",	@"W1",	@"W",	@"W",	@"W",	@"W",	@"W",	@"W",	@"W",	@"W",	@"W2",	@"WW3",	@"WW2",	@"W5",	@"W4",	@"W",	@"W1",	@"W2",	@"W",	@"W1",	@"WW2",	@"W1",	@"U1",	@"UU1",	@"UU2",	@"U1",	@"U1",	@"U1",	@"U1",	@"U1",	@"U",	@"UU",	@"UU3",	@"UU3",	@"UU1",	@"U2",	@"U",	@"U2",	@"U2",	@"U2",	@"U2",	@"U4",	@"U2",	@"U1",	@"U2",	@"U3",	@"U2",	@"U4",	@"U2",	@"UU",	@"UU1",	@"U1",	@"B",	@"BB1",	@"B2",	@"BB3",	@"B1",	@"B2",	@"B2",	@"B",	@"BB",	@"B1",	@"B3",	@"BB1",	@"BB1",	@"BB1",	@"BB1",	@"BB",	@"BB1",	@"BB1",	@"B4",	@"BB",	@"BBB4",	@"B1",	@"B1",	@"B1",	@"B1",	@"B1",	@"B2",	@"B",	@"BB3",	@"BB3",	@"R",	@"RR",	@"RR1",	@"R",	@"RR",	@"RR3",	@"R",	@"R1",	@"RR",	@"RR3",	@"R1",	@"R1",	@"R1",	@"RR2",	@"R2",	@"RR2",	@"RR4",	@"R2",	@"RR2",	@"R1",	@"RRR5",	@"R",	@"R1",	@"RR2",	@"R1",	@"R",	@"RR3",	@"R3",	@"R1",	@"RR3",	@"G",	@"GGG1",	@"G2",	@"G2",	@"GG",	@"G2",	@"G",	@"G2",	@"G3",	@"G1",	@"G4",	@"G1",	@"GG1",	@"G",	@"G1",	@"G2",	@"G1",	@"G2",	@"G1",	@"G1",	@"G",	@"GG1",	@"GG1",	@"G2",	@"G2",	@"G1",	@"G1",	@"G1",	@"GG2",	@"GGG3",
